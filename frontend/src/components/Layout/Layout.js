    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Switch>
          ...
          <Route
            path={'/admin/caseserial'}
            exact
            component={CaseserialTablePage}
          />
          <Route
            path={'/admin/caseserial/new'}
            exact
            component={CaseserialFormPage}
          />
          <Route
            path={'/admin/caseserial/:id/edit'}
            exact
            component={CaseserialFormPage}
          />
          <Route
            path={'/admin/caseserial/:id'}
            exact
            component={CaseserialViewPage}
          />

          <Route
            path={'/admin/casestatus'}
            exact
            component={CasestatusTablePage}
          />
          <Route
            path={'/admin/casestatus/new'}
            exact
            component={CasestatusFormPage}
          />
          <Route
            path={'/admin/casestatus/:id/edit'}
            exact
            component={CasestatusFormPage}
          />
          <Route
            path={'/admin/casestatus/:id'}
            exact
            component={CasestatusViewPage}
          />

          <Route
            path={'/admin/casetypes'}
            exact
            component={CasetypesTablePage}
          />
          <Route
            path={'/admin/casetypes/new'}
            exact
            component={CasetypesFormPage}
          />
          <Route
            path={'/admin/casetypes/:id/edit'}
            exact
            component={CasetypesFormPage}
          />
          <Route
            path={'/admin/casetypes/:id'}
            exact
            component={CasetypesViewPage}
          />
          ...
          <Route
            path={'/admin/caseheaderreferences'}
            exact
            component={CaseheaderreferencesTablePage}
          />
          <Route
            path={'/admin/caseheaderreferences/new'}
            exact
            component={CaseheaderreferencesFormPage}
          />
          <Route
            path={'/admin/caseheaderreferences/:id/edit'}
            exact
            component={CaseheaderreferencesFormPage}
          />
          <Route
            path={'/admin/caseheaderreferences/:id'}
            exact
            component={CaseheaderreferencesViewPage}
          />
        </Switch>
        <Fab
          color='primary'

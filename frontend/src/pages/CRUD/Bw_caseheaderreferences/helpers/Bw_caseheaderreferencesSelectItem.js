...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/bw_caseheaderreferences/autocomplete`, { params });
  return response.data;
}

const Bw_caseheaderreferencesSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.bw_caseheaderreferences.hasPermissionToCreate
});

export default connect(select)(
  Bw_caseheaderreferencesSelectItem,
);

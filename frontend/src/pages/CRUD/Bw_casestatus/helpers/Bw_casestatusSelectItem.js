...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/bw_casestatus/autocomplete`, { params });
  return response.data;
}

const Bw_casestatusSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.bw_casestatus.hasPermissionToCreate
});

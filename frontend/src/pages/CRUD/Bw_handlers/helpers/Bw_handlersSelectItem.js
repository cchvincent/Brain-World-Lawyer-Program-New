...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/bw_handlers/autocomplete`, { params });
  return response.data;
}

const Bw_handlersSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.bw_handlers.hasPermissionToCreate
});

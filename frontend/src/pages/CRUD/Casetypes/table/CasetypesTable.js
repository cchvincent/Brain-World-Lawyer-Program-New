...
const CasetypesTable = () => {
  const [filters, setFilters] = React.useState([
    { label: 'Case Types', title: 'casetypes' },
    { label: 'Description (EN)', title: 'desc_en' },
    { label: 'Description (CH)', title: 'desc_ch' },
      ...
      <div>
        {null && (
          <Button
            color='default'
            size='xs'
            onClick={() => dispatch(push(`/admin/casetypes/${cell}`))}
          >
            View
          </Button>
        )}
        <Button
          color='info'
          size='xs'
          onClick={() => history.push(`/admin/casetypes/${cell}/edit`)}
        >
          Edit
        </Button>
        &nbsp;&nbsp;

...
const CaseheaderreferencesTable = () => {
  ...
  const loading = useSelector((store) => store.caseheaderreferences.list.loading);
  ...
  const modalOpen = useSelector((store) => store.caseheaderreferences.list.modalOpen);
  const idToDelete = useSelector((store) => store.caseheaderreferences.list.idToDelete);
  ...
  <div>
    {null && (
    <Button color="default" size="xs" onClick={() => dispatch(push(`/admin/caseheaderreferences/${cell}`))}>
    View
  </Button>
  )}
  <Button color="info" size="xs" onClick={() => history.push(`/admin/caseheaderreferences/${cell}/edit`)}>
  Edit
</Button>
  &nbsp;&nbsp;

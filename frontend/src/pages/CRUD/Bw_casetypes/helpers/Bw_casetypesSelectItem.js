...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/bw_casetypes/autocomplete`, { params });
  return response.data;
}

const Bw_casetypesSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.bw_casetypes.hasPermissionToCreate
});

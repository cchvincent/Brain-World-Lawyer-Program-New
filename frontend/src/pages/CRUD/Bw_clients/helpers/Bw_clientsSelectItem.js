...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/bw_clients/autocomplete`, { params });
  return response.data;
}

const Bw_clientsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.bw_clients.hasPermissionToCreate
});

...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/bw_introducers/autocomplete`, { params });
  return response.data;
}

const Bw_introducersSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.bw_introducers.hasPermissionToCreate
});

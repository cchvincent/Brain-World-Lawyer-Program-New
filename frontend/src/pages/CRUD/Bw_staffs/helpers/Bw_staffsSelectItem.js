...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/bw_staffs/autocomplete`, { params });
  return response.data;
}

const Bw_staffsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.bw_staffs.hasPermissionToCreate
});

...
router.post('/', async (req, res) => {
    await CaseserialService.create(req.body.data, req.currentUser, true, req.headers.referer);
    const payload = true;
...
router.get('/', wrapAsync(async (req, res) => {
  const payload = await CaseserialDBApi.findAll(
    req.query,
  );
...
router.get('/:id', wrapAsync(async (req, res) => {
  const payload = await CaseserialDBApi.findBy(
    { id: req.params.id },
  );
